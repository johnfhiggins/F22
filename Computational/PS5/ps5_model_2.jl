...
indiv_plot = plot([V_test[86,1:11000], K_test[1:11000]], title="Selected individual's capital holding (w/ K for comp)", labels=["Agent 86's capital" "Aggregate capital"], xlabel="Time", ylabel="Capital")
