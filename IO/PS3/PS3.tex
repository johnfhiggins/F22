...
\begin{sol}
    \begin{enumerate}[label=\alph*) ]
        ...
        \item The above analysis pivots on the assumption that the entire market is covered in equilibrium. If the market isn't covered, each firm will be acting as a local monopolist. This will lead to lower welfare relative to the case where the entire market is covered. However, if firms are able to use personalized pricing, they will serve the entire market (assuming that valuations are high enough that each consumer has non-negative utility from the closest firm when prices are zero) and achieve a welfare gain.
    \end{enumerate}
\end{sol}
